...
{{--                                    <div id="output"></div>--}}
{{--                                    <select class="chosen-select" multiple name="categories[]"  style="width:400px">--}}
...
{{--                                </div>--}}
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-text"  name="image" value="{{$article->image}}" >
                                    <img src="{{asset('/images/'.$article->image)}}" style="height:100px;width:100px;">
