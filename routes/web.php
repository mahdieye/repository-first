...
Route::prefix('admin/articles')->middleware('CheckRole')->group(function () {
    ...
    Route::get('/upload-image', 'back\ArticleController@getUploadForm')->name('admin.articles.upload');

    Route::post('/', 'back\ArticleController@postUploadForm')->name('admin.articles.upload');
});
...
Route::get('image-upload', 'back\UploadController@imageUpload')->name('image.upload');
Route::post('image-upload', 'back\UploadController@imageUploadPost')->name('image.upload.post');
